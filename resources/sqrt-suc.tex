...
\begin{tikzpicture}[scale=0.5]
	...
	%%%%%%%%%
	\onslide*<1>{
		\node[fill=red!20,rectangle] at (a5) {$1$};
		\draw [red,thick] (a5.north) to [bend left=45] (a6.north);
		\draw [->,red,thick] (a6.north) to [bend left=45] (a7.north);
	}
	\onslide*<2>{
		\node[fill=red!20, rectangle] at (r1) {$1$};
	}
	\onslide*<3>{
		\draw [->,red,thick] (r1.north) to [bend left=45] (r2.north);
		\node[fill=red!20, rectangle] at (r2) {$1$};
	}
	\onslide*<4>{
		\node[fill=red!20,rectangle] at (a8) {$1$};
	}
...
\caption{$\Successor(V,x), V = \{2,3,5,8,11\}$}
\end{figure}
\end{document}
